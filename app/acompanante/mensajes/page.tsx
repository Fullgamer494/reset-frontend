    ...
    return (
      <div className="min-h-full flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-[11px] text-slate-400 dark:text-slate-300 tracking-[1px] uppercase" style={{ fontFamily: "'JetBrains Mono', monospace" }}>Cargando mensajes...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-full">
      <div className="max-w-2xl mx-auto px-4 sm:px-10 py-8 sm:py-12">
        ...
        <p
          className="text-[11px] tracking-[1.5px] uppercase text-slate-400 dark:text-slate-300 mb-6"
          style={{ fontFamily: "'JetBrains Mono', monospace" }}
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_220px] gap-5">
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-slate-200 dark:border-slate-700/40 bg-white dark:bg-[#0d1f35] rounded-sm p-6 flex flex-col gap-3 min-h-[320px]">
              {messages.length === 0 ? (
                <div className="flex-1 flex flex-col items-center justify-center text-center gap-3 py-10">
                  ...
                  <p className="text-[12px] italic text-slate-400 dark:text-slate-300" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Aún no hay mensajes.
                  </p>
                  <p className="text-[11px] text-slate-300 dark:text-slate-400 leading-relaxed max-w-[180px]" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                    ...
                    <div
                      className={`max-w-[80%] px-4 py-3 rounded-xl ${
                        msg.fromMe
                          ...
                          : "bg-slate-50 dark:bg-[#0a1628] border border-slate-100 dark:border-slate-700/30 text-slate-700 dark:text-slate-200"
                      }`}
                    >
                      <p
            ...
            <div className="flex gap-2">
              <textarea
                ...
                className="flex-1 border border-slate-200 dark:border-slate-700/40 dark:bg-[#070f1a] dark:text-slate-200 dark:placeholder-slate-600 rounded-lg px-4 py-3 text-slate-700 text-[13px] outline-none resize-none focus:border-teal-300 focus:ring-1 focus:ring-teal-100 transition-all disabled:bg-slate-50 dark:disabled:bg-[#0a1628] disabled:text-slate-300 dark:disabled:text-slate-600 disabled:cursor-not-allowed"
          ...
          {/* Sidebar: biblioteca */}
          <div className="flex flex-col gap-4">
            <div className="border border-slate-200 dark:border-slate-700/40 bg-white dark:bg-[#0d1f35] rounded-sm p-5">
              <p
              ...
              <div className="flex flex-col gap-2">
                {library.map((item) => (
                  <button
                    ...
                    className="text-left text-[11px] italic text-slate-500 dark:text-slate-400 hover:text-teal-600 py-2 px-3 rounded-lg hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors border border-transparent hover:border-teal-100 dark:hover:border-teal-800/40"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    {item.text}
                  </button>
