      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-10 py-8 sm:py-12">
        ...
        <div className="border border-slate-200 bg-white rounded-sm p-8 mb-6">
          ...
          {supportedUsers.length === 0 ? (
            <p className="text-[11px] italic text-slate-400 dark:text-slate-500" style={{ fontFamily: "'Playfair Display', serif" }}>No hay usuarios a su cargo aún.</p>
          ) : (
            supportedUsers.map((user) => (
              <div key={user.id} className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-[#0a1628] rounded-lg">
        ...
        <div className="border border-slate-200 dark:border-slate-700/40 bg-white dark:bg-[#0d1f35] rounded-sm p-8 mb-6">
          ...
          {[
            ...
            <div key={label} className="flex items-center gap-4 py-4 border-t border-slate-50 dark:border-slate-700/20">
              <div className="flex-1">
                <p
                  className="text-[9px] tracking-[1.5px] uppercase text-slate-600 dark:text-slate-300 mb-0.5"
                  style={{ fontFamily: "'JetBrains Mono', monospace" }}
                >
                  {label}
                </p>
