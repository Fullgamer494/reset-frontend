    ...
    return (
      <div className="min-h-full">
        <div className="max-w-2xl mx-auto px-4 sm:px-10 py-8 sm:py-12">
          ...
          <div
            className="border border-(--ui-border) bg-(--surface-card) rounded-sm p-10 flex flex-col items-center text-center"
  ...
  return (
    <div className="min-h-full">
      <div className="max-w-2xl mx-auto px-4 sm:px-10 py-8 sm:py-12">
        ...
        {/* Lista de entradas */}
          <div className="border border-(--ui-border) bg-(--surface-card) rounded-sm p-8">
          <p
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      {entry.isShared ? (
                        ...
                        <span
                          className="text-[7px] tracking-[1px] uppercase rs-text-caption bg-(--surface-card-inner) px-2 py-0.5 rounded-full"
                          style={{ fontFamily: "'JetBrains Mono', monospace" }}
                        >
                          Privado
                        </span>
