...
function PlantIllustration() {
  return (
    ...
    >
      {/* Maceta */}
      <path
        d="M52 148 L56 172 Q80 180 104 172 L108 148 Z"
        fill="#e2e8f0"
        stroke="#cbd5e1"
        strokeWidth="1.5"
      />
      <path
        d="M48 144 Q80 152 112 144"
        stroke="#cbd5e1"
        strokeWidth="2"
        strokeLinecap="round"
        fill="none"
      ...
      <path
        d="M80 120 Q60 108 52 92 Q68 90 78 112"
        fill="#0d9488"
        opacity="0.65"
      />
      ...
      <path
        d="M80 112 Q100 100 108 84 Q92 84 80 108"
        fill="#0d9488"
        opacity="0.65"
      />
      ...
      <path
        d="M80 96 Q64 86 58 72 Q72 70 80 90"
        fill="#0d9488"
        opacity="0.8"
      />
      ...
      <path
        d="M80 90 Q96 80 102 66 Q88 66 80 86"
        fill="#0d9488"
        opacity="0.8"
      />
      ...
      />
      <path
        d="M80 58 Q76 52 74 46 Q80 48 80 58"
        fill="#0d9488"
        opacity="0.9"
      />
      <path
        d="M80 58 Q84 52 86 46 Q80 48 80 58"
        fill="#0d9488"
        opacity="0.9"
      />

      {/* Signo de alerta — encima de la planta */}
      <circle cx="80" cy="24" r="16" fill="#fef3c7" stroke="#f59e0b" strokeWidth="1.5" />
      <path
        d="M80 16 L80 25"
        stroke="#f59e0b"
        strokeWidth="2.5"
        strokeLinecap="round"
      />
      <circle cx="80" cy="29" r="1.5" fill="#f59e0b" />
    </svg>
  );
}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 text-center max-w-md">
        ...
        <div>
          ...
          <h1
            className="font-playfair text-[clamp(56px,12vw,96px)] leading-none text-[#0f172a]"
        ...
        <div className="flex flex-col gap-2">
          <h2
            className="font-playfair text-[22px] italic text-[#0f172a]"
          >
          ...
          >
            El camino que buscas no ha sido plantado aún. Puede que haya sido movido o simplemente nunca existió.
          </p>
        </div>
